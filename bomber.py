...
if len(sys.argv) < 2:
    ...
    '\n' + '\t                         G-mail bomber by {}purelxw, enable less secure app access'.format(YELLOW, RED, YELLOW, BLUE).center(76) +
    '\n' + '\t                            GitHub: https://github.com/purelxw\n'.format(YELLOW).center(80) +
...
vemail = input(LightCyan+'[?] '+YELLOW+' Enter Victims Email Address : '+RED)
#subject = input(LightCyan+'[?] '+YELLOW+' Enter The Subject : '+RED)
message = input(LightCyan+'[?] '+YELLOW+' Enter Your Message Here : '+RED)
count = int(input(LightCyan+'[?] '+YELLOW+' Enter How Many Times You Want To Send The Message : '+RED))
print()
